...
let kOldPassNewPassSameMsg      = "Old Password and New Password could not be same!"
...
let kCarCompanyRequired         = "Please select car company."
let kCarModelRequired           = "Please enter car model."
let kCarPlateNumberRequired     = "Please enter car's plate number."
...
let kNoCarAvailable             = "No car available"

//MARK: Travel and Ride related messages
let kFromLocationRequired                   = "From location required."
let kToLocationRequired                     = "To location required."
let kRepeateEndDateRequired                 = "Repeate end date is required for regular travel."
let kRoundTravelDepartureDateRequired       = "Departure date is required for round travel."
let kRoundTravelDepartureTimeRequired       = "Departure time is required for round travel."
let kTravelDepartureDateRequired            = "Departure date is required for travel."
let kTravelDepartureTimeRequired            = "Departure time is required for travel."
let kMyRidesNotAvailable                    = "No rides available"
